...
var creatorList = ['@_riss.bae','@A187ID'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/+628565251134 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/+628565251134 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'A187-ID') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'A187-ID') return res.json(loghandler.invalidKey)
...
router.get('/muslim/asmaulhusna', async (req, res, next) => {
	...
	if(apikeyInput != 'A187-ID') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://islamic-api-zhirrr.vercel.app/api/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/cyberspace', async (req, res, next) => {
	...
	if(apikeyInput != 'A187-ID') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://wallpaper-api-zhirrr.vercel.app/api/cyberspace`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/teknologi', async (req, res, next) => {
	...
	if(apikeyInput != 'A187-ID') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://wallpaper-api-zhirrr.vercel.app/api/technology`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'A187-ID') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://wallpaper-api-zhirrr.vercel.app/api/islamic`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/wallpaper/programming', async (req, res, next) => {
	...
	if(apikeyInput != 'A187-ID') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://wallpaper-api-zhirrr.vercel.app/api/programming`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
